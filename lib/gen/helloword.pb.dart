...
import 'helloword.pbenum.dart';

export 'helloword.pbenum.dart';
...
class UserRequest extends $pb.GeneratedMessage {
  ...
  static const $core.Map<$core.int, UserRequest_RequestType> _UserRequest_RequestTypeByTag = {
    1 : UserRequest_RequestType.userId,
    2 : UserRequest_RequestType.email,
    3 : UserRequest_RequestType.username,
    0 : UserRequest_RequestType.notSet
  };
  ...
  UserRequest_RequestType whichRequestType() => _UserRequest_RequestTypeByTag[$_whichOneof(0)]!;
  ...
  @$pb.TagNumber(4)
  e_usertype get userType => $_getN(3);
  @$pb.TagNumber(4)
  set userType(e_usertype v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class UserResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UserResponse', createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'userInfo')
    ..e<e_usertype>(2, _omitFieldNames ? '' : 'userType', $pb.PbFieldType.OE, defaultOrMaker: e_usertype.OPERATOR, valueOf: e_usertype.valueOf, enumValues: e_usertype.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.String get userInfo => $_getSZ(0);
  @$pb.TagNumber(1)
  set userInfo($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  e_usertype get userType => $_getN(1);
  @$pb.TagNumber(2)
  set userType(e_usertype v) { setField(2, v); }
  @$pb.TagNumber(2)
